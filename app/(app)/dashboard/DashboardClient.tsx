      ...
      >
        ...
        {budget === 0 ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-2 text-center relative">
            ...
            <p className="text-[11px]" style={{ color: '#9CA3AF' }}>Nog geen budget</p>
            <Link href={currentProject ? `/projects/${currentProject.id}?tab=instellingen` : '/projects'}
              className="text-[11px] font-semibold" style={{ color: '#288760' }}>
              Instellen →
            </Link>
          </div>
        ) : (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-3 relative">
              <div className="rounded-xl p-2.5 flex items-center gap-2" style={{ backgroundColor: '#FBF5F5' }}>
                ...
                <div className="min-w-0">
                  ...
                  <p className="truncate" style={{ fontSize: 14, fontWeight: 800, color: '#C0625F', lineHeight: 1.3 }}>{formatShort(totalExpenses)}</p>
                </div>
              </div>
              <div className="rounded-xl p-2.5 flex items-center gap-2" style={{ backgroundColor: '#F5FAF6' }}>
                <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="#7FAF95" strokeWidth={1.75}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <div className="min-w-0">
                  <p style={{ fontSize: 10, color: '#6B7280', fontWeight: 600, lineHeight: 1.2 }}>Resterend</p>
                  <p className="truncate" style={{ fontSize: 14, fontWeight: 800, color: '#3F7A5C', lineHeight: 1.3 }}>{formatShort(Math.max(budget - totalExpenses, 0))}</p>
                </div>
              </div>
            </div>
        ...
        >
          ...
          <div className="flex items-center justify-between mb-3 relative">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-lg flex items-center justify-center shrink-0" style={{ background: 'linear-gradient(135deg, #288760, #5CA87C)' }}>
          ...
          <div className="flex-1 flex flex-col justify-center relative">
            {aiTipLoading && !aiTip ? (
              <div className="rounded-2xl px-3.5 py-3.5 flex items-center gap-1.5" style={{ backgroundColor: '#F0FDF4' }}>
                {[0, 1, 2].map(i => (
